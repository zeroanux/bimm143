...
```
    ...
    Info: Working in directory D:/R_bioinfo/class13
...
According to Reactome, transport of small molecules has the most
significant “Entities p-value”, which doesn’t match the KEGG results. GO
is a dataset of genes without defining correlations between genes while
KEGG defines the relationship between genes and metabolites.
